...
public class ChaosAction implements Serializable, ObjectWithChance
{
    ...
    * Utility method {@link org.mvss.karta.framework.randomization.RandomizationUtils#selectByChaos} can be used by chaos action implementations to filter subjects</br>
    */
   @Builder.Default
