...
@ToString
@NoArgsConstructor
public class ScenarioSetupStepCompleteEvent extends ScenarioEvent
{
   private static final long serialVersionUID = 1L;

   public ScenarioSetupStepCompleteEvent( Event event )
   {
      super( event );
   ...
   public ScenarioSetupStepCompleteEvent( String runName, String featureName, long iterationNumber, String scenarioName, PreparedStep step, StepResult result )
   {
      super( StandardEventsTypes.SCENARIO_SETUP_STEP_COMPLETE_EVENT, runName, featureName, iterationNumber, scenarioName );
