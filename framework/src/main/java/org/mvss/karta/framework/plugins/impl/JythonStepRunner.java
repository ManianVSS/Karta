...
@Log4j2
public class JythonStepRunner implements StepRunner {
    public static final String PLUGIN_NAME = "JythonStepRunner";
    ...
    public StepResult runStep(PreparedStep testStep) throws TestFailureException {
        ...
        try {
            ...
            try (PythonInterpreter interpreter = new PythonInterpreter()) {
                ...
                interpreter.execfile(stepMapping);
                result = interpreter.get("__step_result__", StepResult.class);
    ...
    public StepResult performChaosAction(PreparedChaosAction preparedChaosAction) {
        ...
        try {
            ...
            try (PythonInterpreter interpreter = new PythonInterpreter()) {
                ...
                interpreter.set("__context_bean_registry", testExecutionContext.getContextBeanRegistry());
                interpreter.set("log", log);
                interpreter.execfile(chaosActionMapping);
                result = interpreter.get("__step_result__", StepResult.class);
            } catch (PySyntaxError pySyntaxError) {
    ...
    public boolean runCondition(TestExecutionContext testExecutionContext, String conditionIdentifier) {
        ...
        try {
            ...
            try (PythonInterpreter interpreter = new PythonInterpreter()) {
                ...
                interpreter.set("__context_bean_registry", testExecutionContext.getContextBeanRegistry());
                interpreter.set("log", log);
                interpreter.execfile(conditionMapping);
                return interpreter.get("__step_result__", Boolean.class);
            } catch (PySyntaxError pySyntaxError) {
