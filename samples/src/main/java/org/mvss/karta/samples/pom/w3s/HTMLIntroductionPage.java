...
public class HTMLIntroductionPage extends AbstractPage
{
   ...
   public HTMLIntroductionPage( WebAUT webAUT ) throws PageException
   {
      super( webAUT );
   }
   ...
   public LearnHTMLHomePage goToLearnHTMLHome() throws PageException
   {
      driver.clickElement( learnHTMLHomeLink );
